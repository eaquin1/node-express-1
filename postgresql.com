    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/2037/">SQL Data Analysis 1.3</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2020-05-11 by Yohz Software/Yohz Ventures Sdn Bhd</li>
              </ul>
            </li>
 ...
 <div class="container margin">
   ...
   <div class="row">
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4Nn"> Optimizing SQL: Simplifying Queries with Window Functions</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4Nl"> PostGIS 2.3.11</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Regina Obe</li>
              <li><i class="far fa-clock"></i>&nbsp;2020-05-31</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4Nk"> MongoDB Logical Decoding Plugin – First Community Release on GitHub</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;cary huang</li>
              <li><i class="far fa-clock"></i>&nbsp;2020-05-29</li>
            </ul>
          </div>
        </div>
